...
class ControlsPanel(QWidget):
    def __init__(self, main_window, parent=None):
        ...
        legend_items = [("ELT", "#FAD7A0"), ("View", "#A9DFBF"), ("Table", "#AED6F1"),
                        ("Script", "#F5B041"), ("CTE", "#F5B7B1"), ("Undefined", "#D5DBDB")]
    ...
    def open_artifact_dialog(self):
        cache = self.data_service.get_cache_data()
        conns = self.data_service.get_db_connections()

        dialog = ArtifactSelectionDialog(cache_data=cache, db_connections=conns, parent=self)
        if dialog.exec_():
